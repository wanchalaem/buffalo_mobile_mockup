...
<div class="bg">
    ...
    <div>
        <v-layout row wrap>
            <v-flex xs12 class="ma-8">
                ...
                <v-btn @click="$router.push('/addBufAdmin')" color="green" class="rounded-lg" large block solo medium dark>
                    <h3>เพิ่มควาย</h3>
                </v-btn> 
            </v-flex>
        </v-layout>
    ...
    <v-tabs grow>
        ...
        <v-tab-item> 
                <v-card-text>
                    <v-card @click="$router.push('/infoBuffDetail')" class="mx-auto rounded-lg" max-width="auto">
