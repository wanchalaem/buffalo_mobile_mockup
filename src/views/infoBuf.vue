...
<div>
    ...
    <Navbar icon="mdi-keyboard-backspace" name="ข้อมูลกระบือ" />
    <div class="pa-4">
        <v-layout row wrap>
            <v-flex xs12 class="ma-2">
                <div class="d-flex flex-no-wrap">
                    <div class="ma-3">
                        <v-btn color="teal" outlined medium dark>
                            <h3>เพิ่มกระบือ</h3>
                        </v-btn>
                    ...
                    <v-spacer></v-spacer>
                    <v-flex xs7>
                        <div class="ml-auto text-right ma-3">
                            <v-select dense :items="items" label="มีชีวิตหรือไม่มีชีวิต" outlined></v-select>
                        </div>
                    </v-flex>
