        ...
        <v-row align="center" justify="center">
            <v-col cols="10" sm="8" md="4">
                ...
                <v-card class="pa-5 mt-4">
                    <v-text-field name="name" color="green" type="number" label="เลขบัตรประชาชน" id="id"></v-text-field>
                    <v-text-field name="name" color="green" type="number" label="เบอร์โทรศัพท์" id="id"></v-text-field>
                    <br>
